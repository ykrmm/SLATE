python slate/run.py \
 wandb_conf.name=SLATE_Paper_Legis \
 dataset=DGB-USLegis \
 model=SLATE \
 optim=adam \
 gpu=2 \
 ...
 model.link_pred.dropout_trsf=0.1 \
