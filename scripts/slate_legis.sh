python slate/run.py \
 --multirun \
 wandb_conf.name=SLATE_Search_Legis \
 dataset=DGB-USLegis \
 model=SLATE \
 gpu=2 \
 lr=0.0001 \
 ...
 model.link_pred.dim_pe=5,10,15 \
